...
export default function JoinAsDoctor() {
  ...
  return (
    <PageShell
      ...
      description="انضم لأكبر شبكة لأطباء وصناع الجمال والوجه في فلسطين واجعل عيادتك تظهر لآلاف المراجعين شهرياً."
    >
      <PromoBanner eyebrow="⭐ عرض الأطباء الأوائل — لفترة محدودة" title="سجّل الآن واحصل على أولوية ظهور + مزايا حصرية">
