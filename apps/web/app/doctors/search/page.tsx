...
function SearchPageContent() {
  ...
  return (
    <main className="min-h-screen animate-fade-in bg-transparent pb-24 pt-4 text-right" dir="rtl">
      <div className="section-shell pb-2">
      <section className="page-hero-dark relative overflow-hidden px-6 pb-32 pt-8 sm:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-2">
          <Link href="/" className="btn-malama-ghost mb-6 inline-flex px-4 py-2 text-xs">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tight">
            ابحث عن <span className="text-gradient-gold">طبيبك أو عيادتك</span>
          </h1>
      ...
      <section className="section-shell relative z-20 -mt-12 pb-24">
        {loading && (
          <div className="bento-card p-16 text-center flex flex-col items-center justify-center">
...
export default function SearchPage() {
  return (
    <Suspense fallback={
      <main className="min-h-screen animate-fade-in bg-transparent flex items-center justify-center">
