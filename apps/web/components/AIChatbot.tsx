...
function getBotResponse(text: string): Omit<Message, "sender"> {
  ...
  if (/احجز|حجز|موعد|متاح|متى/.test(t))
    return { text: "حجز موعدك سهل وسريع!\n\n1️⃣ ابحث عن الطبيب حسب التخصص والمدينة\n2️⃣ افتح ملف الطبيب\n3️⃣ أرسل طلب حجز (أو واتساب)\n4️⃣ احفظ رمز الحجز وتابع الحالة من «حجوزاتي»\n\nالأطباء بشارة التوثيق تمت مراجعة بياناتهم من الإدارة.", ctaLink: "/booking", ctaLabel: "نظام الحجز الإلكتروني", ctaIcon: "booking" };
