...
export default function AdSlider({ ads }: { ads: Advertisement[] }) {
  ...
  return (
    <div className="group relative mb-8 w-full overflow-hidden rounded-2xl border border-slate-100 bg-slate-900 shadow-2xl shadow-slate-200/50">
